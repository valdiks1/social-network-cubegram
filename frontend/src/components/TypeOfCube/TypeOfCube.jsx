    ...
    return(
        <div className="type-cube">
            ...
            <div className="inner-type-cube">
                <CubeBtn onClick={() => setType(2)} text={"2x2x2"} img={cube2} />
                <CubeBtn onClick={() => setType(3)} text={"3x3x3"} img={cube3} />
                <CubeBtn onClick={() => setType(4)} text={"4x4x4"} img={cube4} />
                <CubeBtn onClick={() => setType(5)} text={"5x5x5"} img={cube5} />
            </div>
